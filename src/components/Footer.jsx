    ...
    return (
        <footer className='flex justify-center items-center flex-col gap-5 p-10'>
            <a href="#top" className='relative group  hover:scale-105 ease-in-out duration-100'>
                ...
                <img src="./public/icons/logo.svg" alt="logo" className='w-20 bg-background' />
            </a>
            <p className='flex items-center justify-center gap-2 text-xl'>Aman Mourya <img src='./public/icons/copyright.svg' alt='copyright' className='w-4' /> 2024</p>
        </footer>
    )
}
